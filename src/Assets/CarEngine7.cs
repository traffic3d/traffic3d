...
public class CarEngine7 : MonoBehaviour {
    ...
    public materialchangee m = null;



    public List<Transform> nodes;
    public List<Transform> materialchangee;
    ...
    void Start()
    {
        ...
        m = TrafficLight.GetComponent<materialchangee>();
    ...
    private void Stop()
    {
        ...
        if ((((m.CM.color.Equals(Material1.color) || (m.CM.color.Equals(Material5.color))) && (Vector3.Distance(transform.position, TrafficLight.transform.position) < 8f) && (Vector3.Distance(transform.position, CAR6.transform.position) < 15f))))

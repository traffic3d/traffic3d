...
public class AssetReferenceCollection  : IReferenceCollection
{
	...
	public void CollectionFiles ()
	{
		var allFiles = Directory.GetFiles("Assets", "*.*", SearchOption.AllDirectories)
			.Where(c=> System.IO.Path.GetExtension(c) != ".meta")
			.Where(c=> System.IO.Path.GetExtension(c) != ".shader")
			.Where(c=> System.IO.Path.GetExtension(c) != ".cg")
			.Where(c=> System.IO.Path.GetExtension(c) != ".cginc")
			.Where(c=> System.IO.Path.GetExtension(c) != ".cs");

...
namespace UnityEngine.AI
{
    ...
    public class NavMeshSurface : MonoBehaviour
    {
        ...
        public void BuildNavMesh()
        {
            ...
            if (m_CollectObjects == CollectObjects.All || m_CollectObjects == CollectObjects.Children || m_CollectObjects == CollectObjects.AllNavMeshModifiers)
            {
        ...
        List<NavMeshBuildSource> CollectSources()
        {
            ...
            if (!EditorApplication.isPlaying)
            {
                ...
                else if (m_CollectObjects == CollectObjects.AllNavMeshModifiers)
                {
                    UnityEditor.AI.NavMeshBuilder.CollectSourcesInStage(
                        null, m_LayerMask, m_UseGeometry, m_DefaultArea, markups, gameObject.scene, sources);
                }
            ...
            if(m_CollectObjects == CollectObjects.AllNavMeshModifiers)
            {
                sources.RemoveAll(s => s.component == null || s.component.gameObject.GetComponent<NavMeshModifier>() == null);
            }
